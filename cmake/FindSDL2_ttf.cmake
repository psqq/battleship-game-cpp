...
get_filename_component(SDL2_TTF_LIBRARIES_DIR ${SDL2_TTF_LIBRARIES} DIRECTORY)

if(WIN32 AND SDL2_TTF_LIBRARIES)
	find_file(SDL2_TTF_RUNTIME_LIBRARY
		...
		${SDL2_TTF_LIB_HINTS}
		PATHS
		${SDL2_TTF_LIBRARIES_DIR}
        ENV SDL2TTFDIR
		PATH_SUFFIXES bin lib ${SDL2_TTF_LIB_PATH_SUFFIX})
endif()

if(WIN32 AND SDL2_TTF_LIBRARIES)
	find_file(SDL2_TTF_LIBFREETYPE_RUNTIME_LIBRARY
		NAMES
		libfreetype-6.dll
		HINTS
		${SDL2_TTF_LIB_HINTS}
...
if(WIN32 AND SDL2_TTF_LIBRARIES)
	find_file(SDL2_TTF_ZLIB1_RUNTIME_LIBRARY
		NAMES
		zlib1.dll
		HINTS
		${SDL2_TTF_LIB_HINTS}
